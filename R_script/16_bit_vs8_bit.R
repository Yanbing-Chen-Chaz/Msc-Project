...
df1 <- read.csv("C:\\Users\\75695\\Desktop\\results\\Hela1\\mean segmentation accuracy2.csv", check.names = FALSE)
df2 <- read.csv("C:\\Users\\75695\\Desktop\\results\\Hela1\\segmentation accuracy (t=0.5)2.csv", check.names = FALSE)
...
method1 <- "cellpose-SAM(16bit)"
method2 <- "cellpose-SAM(8bit)"
method3 <- "cellpose cyto3(16bit)"
method4 <- "cellpose cyto3(8bit)"
