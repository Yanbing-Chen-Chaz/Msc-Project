...
#modelpath = r"C:\Users\75695\Desktop\image\testing\cho1\cho1_8bit _cellpose3"
#model = models.CellposeModel(pretrained_model=modelpath, gpu=True)
# *** change to your google drive folder path ***
dir = r"C:\Users\75695\Desktop\image\testing\cho1\cho1_8bit_cellpose3"
dir = Path(dir)
if not dir.exists():
...
for i in trange(len(files)):
    ...
    io.masks_flows_to_seg(img, masks, flows, file_name, channels=[0, 0], diams=diams)